 ...
 * 从数据库读取元数据
 */
public class CustomJDBCMetadataProvider extends AbstractReloadingMetadataProvider {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(CustomJDBCMetadataProvider.class);
     ...
     * @deprecated
     */
    public CustomJDBCMetadataProvider(Resource resource, Timer timer, long maxMetadataCacheDuration)
     ...
     * @throws MetadataProviderException thrown if there is a problem retrieving information about the resource
     */
    public CustomJDBCMetadataProvider(Timer timer, Resource resource) throws MetadataProviderException {
        super(timer);
